  ...
  const questions = [
    {
      ...
      options: [
        ...
        "A cloud platform for building and extending applications",
    ...
    {
      id: 2,
      question: "Which of the following is a service in SAP BTP?",
      options: [
        "SAP HANA Cloud",
        "SAP Analytics Cloud",
    ...
    {
      id: 3,
      question: "What is the purpose of SAP BTP Cloud Foundry?",
      options: [
        "To manage databases",
    ...
    {
      id: 5,
      question: "What is the purpose of SAP BTP Cockpit?",
      options: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-8">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold">SAP BTP Test</h2>
