...
const TMTest = () => {
  ...
  const questions = [
    ...
    {
      id: 2,
      question: "Which of the following is a key feature of SAP TM?",
      options: [
        "Route optimization",
    ...
    {
      id: 3,
      question: "What is the purpose of Freight Units in SAP TM?",
      options: [
        "To track customer orders",
        "To manage warehouse inventory",
        "To group related transportation activities",
    ...
    {
      id: 4,
      question: "Which of the following is a transportation planning tool in SAP TM?",
      options: [
        "Warehouse Management",
    ...
    {
      id: 5,
      question: "What is the purpose of Freight Settlement in SAP TM?",
      options: [
        "To track shipments",
        "To manage routes",
        "To handle carrier payments",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-8">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold">SAP TM Test</h2>
