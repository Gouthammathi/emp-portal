...
const TestInstructions = () => {
  ...
  const getModuleInstructions = (moduleId) => {
    const baseInstructions = [
      {
        title: 'Navigation',
        content: 'You can navigate between questions using the Previous and Next buttons.',
        icon: <FaExchangeAlt className="w-6 h-6 text-green-500" />
      },
      {
        title: 'Question Status',
        content: 'The number of answered questions will be displayed at the top of the test.',
      ...
      {
        title: 'Submission',
        content: 'You can submit the test at any time. After submission, you will see your score.',
    ...
    const moduleSpecificInstructions = {
      ewm: [
        {
          title: 'Time Limit',
          content: 'The test has a duration of 60 minutes. The timer will start as soon as you begin the test.',
    ...
    return moduleSpecificInstructions[moduleId] || moduleSpecificInstructions.btp;
  };

  const instructions = getModuleInstructions(moduleId);
